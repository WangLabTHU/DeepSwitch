...
def main():
    ...
    for epoch in range(num_epochs):
        ...
        # Model validation
        average_loss, accuracy, precision, recall, f1, auc_roc = evaluate_model(model, criterion, val_loader, save_auc_data_path="Figures/Monitor_roc.npz")
        print('Epoch ', epoch+1)
    ...
    # Model save
    # save_path = 'Model/best_monitor.pth'
